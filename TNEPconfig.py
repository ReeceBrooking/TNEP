...
class TNEPconfig:
    ...
    adam_use_ema: bool = True
    adam_ema_momentum: float = 0.99
    ...
    adam_lr_decay: bool = True
    adam_lr_decay_factor: float = 0.8
    adam_lr_decay_patience: int = 50
